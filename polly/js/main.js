...
var fetchVoice = function(speakText) {
    ...
    //oReq.open('GETT', 'https://rdh13jptya.execute-api.eu-west-1.amazonaws.com/prod/pollyExecute?speakText=' + encodeURIComponent(speakText));
    ...
    oReq.body ('speakText=' + encodeURIComponent(speakText));
